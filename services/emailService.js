 ...
 * @param {string} options.senderEmail - The sender's email address.
 ...
 */
const sendMail = async ({ senderEmail, emailbody, subject }) => {
  try {
 ...
 * @returns {Promise<{ status: number, message: string }>} A Promise that resolves with a success message or
